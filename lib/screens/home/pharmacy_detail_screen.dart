                ...
                children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                           children: [
                              Text(
                                pharmacy.name, // Repeated from AppBar, maybe style differently
                  ...
                  const Row(
                    children: [
                       ...
                       Text('Mon - Fri: 09:00 AM - 6:00 PM', style: TextStyle(fontSize: 14, color: darkGrey)),
                    ],
                  ),
                   const SizedBox(height: 4),
                  const Row(
                    children: [
                       Icon(Icons.access_time, size: 16, color: darkGrey),
                       SizedBox(width: 8),
                       Text('Sat - Sun: Closed', style: TextStyle(fontSize: 14, color: darkGrey)),
                    ],
                  ),
                  const Divider(height: 30, thickness: 1),
                  ...
                  const Text(
                    'This pharmacy offers a wide range of prescription and over-the-counter medications. Pharmacist consultation available. Delivery services may be offered.',
                     style: TextStyle(fontSize: 14, color: darkGrey, height: 1.4),
                  ),
